...
public class ARC3Info {
	...
	public ARC3Info(String _unitName, String _creatorAddress, AVMNFTStandard _standard, AVMNFTType _type, AVMNFTState _state, String _description, String _category, String _chain, ArrayList<String> _origins) {
		super();
	...
	public ARC3Info(String _unitName, String _creatorAddress, AVMNFTStandard _standard, AVMNFTType _type, AVMNFTState _state, String _description, String _category, String _chain, ArrayList<String> _origins, ArrayList<String> _linked_tokens) {
		super();
		this.unitName = _unitName;
		this.creatorAddress = _creatorAddress;
		this.standard = _standard;
