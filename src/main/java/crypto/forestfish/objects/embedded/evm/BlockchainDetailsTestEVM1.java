...
public class BlockchainDetailsTestEVM1 {
	...
	public static HashMap<EVMChain, EVMChainInfo> getTestnetEVMNetworks() {
		...
		EVMChainInfo meroneum_test = new EVMChainInfo(
				...
				new EVMCurrency("Meroneum Testnet Gas Token", "MERON", 18), 
				EVMPriceMechanism.LEGACY.toString(),30,
				"30000000000", //30 gwei
				null, // enforced min gasprice
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://testnet-node1.meronscan.ai/");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://testnet.meronscan.ai");
				}},
				new ArrayList<String>() {{
					this.add("<TODO>");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/3369");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.MERONEUMTEST, meroneum_test);
		
		// tac
		EVMChainInfo tac_test = new EVMChainInfo(
				...
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://turin.rpc.tac.build");
					this.add("https://rpc.ankr.com/tac_turin");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://turin.explorer.tac.build");
				}},
				new ArrayList<String>() {{
					this.add("https://turin.faucet.tac.build/");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/2390");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.TACTEST, tac_test);
		
		// kiteai_test
		EVMChainInfo kiteai_test = new EVMChainInfo(
				EVMChain.KITEAITEST.toString(), 
				"KiteAI Testnet", 
				2368L, 
				BlockchainType.PUBLIC.toString(),
				new EVMCurrency("KiteAI Testnet Gas Token", "KITE", 18), 
				EVMPriceMechanism.LEGACY.toString(),30,
				"30000000000", //30 gwei
				null, // enforced min gasprice
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://rpc-testnet.gokite.ai");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://testnet.kitescan.ai");
				}},
				new ArrayList<String>() {{
					this.add("https://faucet.gokite.ai/");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/2368");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.KITEAITEST, kiteai_test);
		
		// soneium_test
		EVMChainInfo soneium_test = new EVMChainInfo(
				EVMChain.SONEIUMTEST.toString(), 
				"Soneium Testnet Minato", 
				1946L, 
				BlockchainType.PUBLIC.toString(),
				new EVMCurrency("Soneium Testnet Minato Gas Token", "ETH", 18), 
				EVMPriceMechanism.LEGACY.toString(),30,
				"30000000000", //30 gwei
				null, // enforced min gasprice
				"300000", //300k units
				...
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://soneium-minato.blockscout.com");
				}},
				new ArrayList<String>() {{
					this.add("<TODO>");
				}},
				...
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.SONEIUMTEST, soneium_test);
		
		// happychain_test
		EVMChainInfo happychain_test = new EVMChainInfo(
				...
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://happy-testnet-sepolia.explorer.caldera.xyz");
				}},
				new ArrayList<String>() {{
					this.add("<TODO>");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/216");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.HAPPYCHAINTEST, happychain_test);
		...
		EVMChainInfo haust_test = new EVMChainInfo(
				...
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.HAUST1TEST, haust_test);
		...
		EVMChainInfo unichain_test = new EVMChainInfo(
				...
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://unichain-sepolia-rpc.publicnode.com");
		...
		EVMChainInfo overprotocol_test = new EVMChainInfo(
				...
				new ArrayList<String>() {{
					...
					this.add("https://rpc.dolphin.overprotocol.com");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
		...
		// xr_sepolia_test
		EVMChainInfo xr_sepolia_test = new EVMChainInfo(
				...
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.XRSEPOLIATEST, xr_sepolia_test);
		
		// autheo_test
		EVMChainInfo autheo_test = new EVMChainInfo(
				...
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://testnet-rpc1.autheo.com");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://testnet-explorer.autheo.com");
				}},
				new ArrayList<String>() {{
					this.add("https://testnet-faucet.autheo.com");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/785");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.AUTHEOTEST, autheo_test);
		
		// electra_test
		EVMChainInfo electra_test = new EVMChainInfo(
				...
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://rpc.testnet.electranetwork.tech");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://scan.testnet.electranetwork.tech");
				}},
				new ArrayList<String>() {{
					this.add("<TODO>");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/871");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.ELECTRATEST, electra_test);
		
		// subtensor_test
		EVMChainInfo subtensor_test = new EVMChainInfo(
				EVMChain.SUBTENSORTEST.toString(), 
				"Subtensor EVM Testnet", 
				945L, 
				BlockchainType.PUBLIC.toString(),
				new EVMCurrency("Subtensor EVM Testnet Gas Token", "TAO", 18), 
				EVMPriceMechanism.LEGACY.toString(),30,
				"30000000000", //30 gwei
				null, // enforced min gasprice
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://test.chain.opentensor.ai");
					this.add("https://evm-testnet.dev.opentensor.ai");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://evm-testscan.dev.opentensor.ai");
				}},
				new ArrayList<String>() {{
					this.add("<TODO>");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/945");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.SUBTENSORTEST, subtensor_test);
		
		// hyperliquid_test
		EVMChainInfo hyperliquid_test = new EVMChainInfo(
				...
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://api.hyperliquid-testnet.xyz/evm");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				...
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/998");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.HYPERLIQUIDTEST, hyperliquid_test);
		...
		EVMChainInfo guru_test = new EVMChainInfo(
				...
				new ArrayList<String>() {{
					...
					this.add("https://rpc-test.gurunetwork.ai");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
		...
		// ultra_test
		EVMChainInfo ultra_test = new EVMChainInfo(
				EVMChain.ULTRATEST.toString(), 
				"Ultra EVM Network Testnet", 
				18881L, 
				BlockchainType.PUBLIC.toString(),
				new EVMCurrency("Ultra EVM Network Testnet Gas Token", "UOS", 18), 
				EVMPriceMechanism.LEGACY.toString(),30,
				"30000000000", //30 gwei
				null, // enforced min gasprice
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://evm.test.ultra.eosusa.io");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://evmexplorer.testnet.ultra.io");
				}},
				new ArrayList<String>() {{
					this.add("<TODO>");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/18881");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.ULTRATEST, ultra_test);
		...
		EVMChainInfo arbitrumsep = new EVMChainInfo(
				...
				new ArrayList<String>() {{
					...
					this.add("https://arbitrum-sepolia-rpc.publicnode.com");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
		...
		// core_test
		EVMChainInfo core_test = new EVMChainInfo(
				EVMChain.CORETEST.toString(), 
				"Core Blockchain Testnet2", 
				1114L, 
				BlockchainType.PUBLIC.toString(),
				new EVMCurrency("Core Blockchain Testnet2 Gas Token", "tCORE2", 18), 
				EVMPriceMechanism.LEGACY.toString(),30,
				"30000000000", //30 gwei
				null, // enforced min gasprice
				"300000", //300k units
				new ArrayList<String>() {{
					this.add("https://rpc.test2.btcs.network/");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
				new ArrayList<String>() {{
					this.add("https://scan.test2.btcs.network");
				}},
				new ArrayList<String>() {{
					this.add("https://scan.test2.btcs.network/faucet");
				}},
				new ArrayList<String>() {{
					this.add("https://chainlist.org/chain/1114");
				}},
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.CORETEST, core_test);
		
		// coredao_test
		EVMChainInfo coredao_test = new EVMChainInfo(
				EVMChain.COREDAOTEST.toString(), 
				"Core DAO Testnet", 
				1115L, 
				BlockchainType.PUBLIC.toString(),
				...
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.COREDAOTEST, coredao_test);
		...
		EVMChainInfo autonomys_test = new EVMChainInfo(
				EVMChain.AUTONOMYSNOVATEST.toString(), 
				...
				BlockchainTokenDetailsEVM.generateDummyTokenIndex(),
				BlockchainTokenDetailsEVM.generateDummyNFTIndex());
		networks.put(EVMChain.AUTONOMYSNOVATEST, autonomys_test);
		...
		EVMChainInfo xone_test = new EVMChainInfo(
				...
				new ArrayList<String>() {{
					...
					this.add("https://rpc-testnet.xone.org");
					this.add("https://rpc-testnet.knight.center");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
		...
		EVMChainInfo corn_test = new EVMChainInfo(
				...
				new ArrayList<String>() {{
					...
					this.add("https://testnet.corn-rpc.com");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
		...
		EVMChainInfo form_test = new EVMChainInfo(
				...
				new ArrayList<String>() {{
					...
					this.add("https://sepolia-rpc.form.network/http");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
		...
		EVMChainInfo metis_test2 = new EVMChainInfo(
				...
				new ArrayList<String>() {{
					...
					this.add("https://metis-sepolia-rpc.publicnode.com");
				}}, 
				new ArrayList<String>(), // archive nodes (if available)
				new ArrayList<String>(),
				new ArrayList<String>(),
