...
public class EVMKnownAccountAddress {
	...
	public EVMKnownAccountAddress(String name, String address, AddressCategory category, ArrayList<String> origins) {
		super();
		this.name = name;
