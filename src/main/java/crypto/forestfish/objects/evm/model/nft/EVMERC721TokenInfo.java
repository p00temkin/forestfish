...
public class EVMERC721TokenInfo {
	...
	public EVMERC721TokenInfo() {
		super();
	}

	public EVMERC721TokenInfo(String _symbol, String _contractAddress, Long _mintBlock, String _description, String _category, String _chain, ArrayList<String> _origins) {
		super();
		this.symbol = _symbol;
	...
	public EVMERC721TokenInfo(String _symbol, String _contractAddress, Long _mintBlock, String _description, String _category, String _chain, ArrayList<String> _origins, ArrayList<String> _linked_tokens) {
		super();
		this.symbol = _symbol;
		this.contractAddress = _contractAddress;
		this.mintBlock = _mintBlock;
